...
const Footer = () => {
  return (
    <footer style={{ backgroundColor: 'var(--color-surface)', padding: 'var(--space-8) var(--space-3) var(--space-4)', color: 'var(--color-text)', borderTop: '1px solid var(--color-border)', transition: 'all 0.3s ease' }}>
      <div className="container">
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 'var(--space-6)', marginBottom: 'var(--space-6)' }}>
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: 'var(--space-2)' }}>
              <li><Link to="/shop" style={{ color: 'var(--color-text)', opacity: 0.8, textDecoration: 'none' }}>Shop Collection</Link></li>
              <li><Link to="/our-story" style={{ color: 'var(--color-text)', opacity: 0.8, textDecoration: 'none' }}>Our Story</Link></li>
              <li><Link to="/articles" style={{ color: 'var(--color-text)', opacity: 0.8, textDecoration: 'none' }}>Journal & Recipes</Link></li>
              <li><Link to="/signup" style={{ color: 'var(--color-text)', opacity: 0.8, textDecoration: 'none' }}>Join the Society</Link></li>
            </ul>
          </div>
          <div>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: 'var(--space-2)' }}>
              <li><a href="#" style={{ color: 'var(--color-text)', opacity: 0.8, textDecoration: 'none' }}>Shipping & Returns</a></li>
              <li><a href="#" style={{ color: 'var(--color-text)', opacity: 0.8, textDecoration: 'none' }}>FAQ</a></li>
              <li><a href="#" style={{ color: 'var(--color-text)', opacity: 0.8, textDecoration: 'none' }}>Corporate Gifting</a></li>
              <li><Link to="/contact" style={{ color: 'var(--color-text)', opacity: 0.8, textDecoration: 'none' }}>Contact Us</Link></li>
            </ul>
          </div>
          <div>
            ...
            <div style={{ display: 'flex', gap: 'var(--space-3)' }}>
              <a href="#" style={{ color: 'var(--color-primary)' }} aria-label="Instagram">
              ...
              <a href="#" style={{ color: 'var(--color-primary)' }} aria-label="Facebook">
        ...
        <div style={{ borderTop: '1px solid var(--color-border)', paddingTop: 'var(--space-4)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 'var(--space-3)' }}>
          ...
          <div style={{ display: 'flex', gap: 'var(--space-3)' }}>
            <a href="#" style={{ opacity: 0.6, fontSize: '0.8rem', color: 'var(--color-text)', textDecoration: 'none' }}>Privacy Policy</a>
            <a href="#" style={{ opacity: 0.6, fontSize: '0.8rem', color: 'var(--color-text)', textDecoration: 'none' }}>Terms of Service</a>
          </div>
        </div>
      </div>
    </footer>
