...
const Navbar = () => {
  ...
  const navStyle = {
    ...
    backgroundColor: isScrolled 
      ? (document.documentElement.getAttribute('data-theme') === 'dark' ? 'rgba(26, 17, 10, 0.85)' : 'rgba(255, 250, 240, 0.85)')
      : 'transparent',
    ...
    <header style={navStyle}>
      <div className="container nav">
        ...
        <div className="nav-right">
          ...
          <button className="icon-btn" style={{ position: 'relative', margin: '0 12px' }} onClick={() => setIsCartOpen(true)} aria-label="Cart">
